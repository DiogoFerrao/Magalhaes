...
def detect(save_img=False):
    ...
    save_dir = Path(opt.output_dir)  # increment run
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        line = (
                            (cls, conf, *xywh) if opt.save_conf else (cls, *xywh)
                        )  # label format
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_txt", action="store_true", help="save txt labels")
    parser.add_argument(
        "--classes",
        nargs="+",
        type=int,
    ...
    parser.add_argument("--output_dir", default="./out", help="output folder")
