...
from utils.datasets import *  # noqa: F403
from utils.general import *  # noqa: F403
...
def detect(save_img=False):
    ...
    # # Name output folder accordingly
    # dataset_name = opt.source.replace("/", "_").replace(".", "")[17:-1]
    # timestr = time.strftime("%Y_%m_%d-%H_%M_%S-")
    # out = (
    #     "/media/magalhaes/output/detect/"
    #     + dataset_name
    #     + "/"
    #     + timestr
    #     + str(opt.conf_thres)
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                # 480x640 -> 640x640
                im0 = np.pad(im0, ((80, 80), (80, 80), (0, 0)))
...
if __name__ == "__main__":
    ...
    shutil.copy(opt.names, opt.output)
